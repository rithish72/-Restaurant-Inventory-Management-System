...
const Home = () => {
    ...
    return (
        <div className="container-home">
            <div
                className={`home-container ${darkMode ? "dark-bg-db" : "light-bg-db"} animate-in`}
            >
                <h2
                ...
                <div className="row justify-content-center animate-in">
                    <div className="col-md-4 mb-4 animate-in">
                        <div
                            className={`card shadow-sm h-100 ${darkMode ? "bg-dark text-light" : ""} card-animate`}
                        >
                            <div className="card-body text-center">
                                <h5 className="card-title">📦 Inventory</h5>
                                <p className="card-text">
                                    Track all your ingredients and stock levels.
                                </p>
                                <Link
                                    to="/inventory_list"
                    ...
                    <div className="col-md-4 mb-4 animate-in">
                        ...
                        >
                            <div className="card-body text-center">
                                ...
                                <p className="card-text">
                                    Keep track of your suppliers and their
                                    details.
                                </p>
                                <Link
                                    to="/suppliers"
                    ...
                    <div className="col-md-4 mb-4 animate-in">
                        ...
                        >
                            <div className="card-body text-center">
                                ...
                                <p className="card-text">
                                    View and manage purchase orders efficiently.
                                </p>
                                <Link
                                    to="/orders"
